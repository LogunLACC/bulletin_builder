...
This script inserts the project's `src` directory on sys.path then constructs an
AppStub whose executor runs work synchronously so the importer's threaded worker
runs inline and updates `app.sections_data`.
"""
...
# Ensure local package import via src/
